  ...
  return (
    <div id="contact" className="md:ml-[25%] md:w-[75%] py-10 max-w-[1040px]   mx-auto flex justify-center items-center p-4 ">
        <div class="">
            <div class="grid md:grid-cols-2 sm:gap-2 ">
                ...
                <div class=" h-[30rem] md:w-full ">
                    <div class="p-">
                        ...
                        <div class="capitalize py-10 font-bold text-secondary relative">
                            <p class="absolute h-28 w-1 bg-primary left-0 rounded"></p>
            ...
            {/* map  */}
           <div id='map' class="relative h-96 w-full mx-auto">
                <p>Map</p>
